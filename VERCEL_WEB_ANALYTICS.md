...
For plain HTML sites like this project, you can add the following script to your `.html` files:
...
1. The first script initializes the `window.va` function which queues any analytics events
2. The second script deferred loads the Vercel insights script that will automatically track:
   - Page views
   - User interactions
   - Performance metrics
